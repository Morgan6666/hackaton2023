...
class ServiceResponse {
    ...
    categoryDoesntExists() {
        return this.uniqueServiceErrorRes(messageConstants_3.SUCCESS_FALSE, messageConstants_2.CODE_404, messageConstants_1.CATEGORY_DOESNT_EXIST);
    }
    ...
    successRes() {
        return this.uniqueServiceErrorRes(messageConstants_3.SUCCESS_TRUE, messageConstants_1.CODE_200, messageConstants_1.MESSAGE_SUCCESS);
    }
    userSessionNotFound() {
    ...
    categoryGetError() {
        return this.uniqueServiceErrorRes(messageConstants_3.SUCCESS_FALSE, messageConstants_2.CODE_500, messageConstants_1.GET_CATEGORY_ERROR);
    }
    polisSuccessAdded() {
