...
class AddFood extends StatefulWidget {
  ...
  AddFood(this.data);
  @override
  AddFoodScreen createState() => AddFoodScreen();
}

class AddFoodScreen extends State<AddFood> {
                ...
                child: GestureDetector(
                  onTap: () {
                    Navigator.push(context,
                        SlideRightRoute(widget: GetFoodInfoScreen().build(context)));
                  },
                  child: Image.asset(
                  ...
                  child: Container(
                      ...
                      Padding(
                        padding: getPadding(
                          ...
                          child: Text(
                        "Название магазина:${this.widget.data['shop_name']}",
