...
// String name, String description, String category_name,
//     String time_start, String time_end, int user_id, String city_name

class ViewRelax extends StatefulWidget {
  final Map data;

  ViewRelax(this.data);
  @override
  ViewRelaxScreen createState() => ViewRelaxScreen();
}

class ViewRelaxScreen extends State<ViewRelax> {
  @override
                        ...
                        child: GestureDetector(
                          onTap: () {
                            Navigator.push(context,
                                SlideRightRoute(widget: GetRelaxInfoScreen().build(context)));
                          },
                          child: Image.asset(
                            ImageConstant.endButton,
                            height: _media_height / 20,
                    ...
                    Padding(
                      ...
                      child: Container(
                          ...
                          Padding(
                              ...
                              child: Text(
                                "Название отдыха:${this.widget.data['relax_name']}",
