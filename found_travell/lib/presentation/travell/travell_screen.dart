...
import 'package:found_travell/presentation/travell/widget/travels_list_widget.dart';
...
class GetTravel extends StatefulWidget {
  ...
  @override
  GetTravelInfoScreen createState() => GetTravelInfoScreen();
}

class GetTravelInfoScreen extends State<GetTravel> {
  @override
